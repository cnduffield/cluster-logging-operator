...
func (e GCloudLogging) Name() string {
	return "gcloudloggingTemplate"
}

func (e GCloudLogging) Template() string {
...
`
			vrls = append(vrls, fmt.Sprintf(changeIndexName, o.GCloudLogging.StructuredTypeKey))
		case es.StructuredTypeKey == "" && es.StructuredTypeName != "":
			changeIndexName := `
if .log_type == "application" && .structured != null {
...
`
			vrls = append(vrls, fmt.Sprintf(changeIndexName, o.GCloudLogging.StructuredTypeName))
		case es.StructuredTypeKey != "" && es.StructuredTypeName != "":
			changeIndexName := `
if .log_type == "application" && .structured != null {
  val = .%s
...
`
			vrls = append(vrls, fmt.Sprintf(changeIndexName, o.GCloudLogging.StructuredTypeKey, o.GCloudLogging.StructuredTypeName))
		}
	}

	return Remap{
		Desc:        "Set Gcloudlogging index",
		ComponentID: id,
